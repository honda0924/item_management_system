    ...
    <table class="table col">
      ...
      <tbody>
        <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr data-item=<?php echo e($cart->id); ?>>
            <td class="product_name"><?php echo e($cart->product_name); ?></td>
            <td class="item_num"><?php echo e($cart->item_num); ?></td>
            <td class="price"><?php echo e($cart->price); ?></td>
            <td class="amount" data-num=<?php echo e($cart->item_num); ?> data-price=<?php echo e($cart->price); ?>></td>
            <td class="d-flex">
              <button type="button" class="cart_delete_btn mr-3" data-toggle="modal" data-target="#modal_delete" data-id="<?php echo e($cart->id); ?>" data-name="<?php echo e($cart->product_name); ?>" data-url="/cart/delete/<?php echo e($cart->id); ?>">削除</button>
            </td>
          </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/honda/dev/item_management_system/resources/views/cart/show.blade.php ENDPATH**/ ?>