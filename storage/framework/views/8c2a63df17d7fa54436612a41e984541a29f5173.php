        ...
        document.querySelector('#confirm-register').addEventListener("click", function () {
          $.ajax({
            ...
            const finishedHTML = `<h3>登録完了</h3>
                                  <p>${data}</p>
                                  <a href="<?php echo e(url('/items')); ?>">商品一覧に戻る</a>`;
            $("#ajax-confirm").remove();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/honda/dev/item_management_system/resources/views/shippings/create.blade.php ENDPATH**/ ?>